            ...
            <Transition name="slide-down">
                <div v-if="props.loginEmailCheckState === 'valid'" class="space-y-3">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            <Input id="login-password" ref="passwordInput" :model-value="props.password"
...
// Watch for login email validation success and focus password field
watch(() => props.loginEmailCheckState, async (newState) => {
    if (newState === 'valid') {
        await nextTick()
